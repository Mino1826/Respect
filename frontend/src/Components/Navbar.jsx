  ...
  return (
    <>
      <div className="flex items-center justify-around font-medium h-28 bg-customGray ">
        <Link to="/">
          <img src={assets.logo} alt="" className="w-40 bg-transparent" />
        </Link>
        ...
        <ul className="hidden sm:flex gap-5 text-sm text-gray-700">
          ...
          <NavLink to="/b2b" className="flex flex-col items-center gap-1">
            <p>{t("b2b")}</p>
            <hr className="w-2/4 border-none h-[1.5px] bg-gray-700 hidden" />
          </NavLink>
          <NavLink to="/gifts" className="flex flex-col items-center gap-1">
            <p>{t("gifts.title2")}</p>
            <hr className="w-2/4 border-none h-[1.5px] bg-gray-700 hidden" />
          </NavLink>
        </ul>
